            ...
            <div>
                {tasks.map((task) => (
                    <div
                        ...
                        className={`p-4 m-2 rounded bg-gray-800 cursor-grab opacity-80 hover:opacity-100 ${isDeleting === task.id ? 'animate-ping' : ''}`}
                    >
                        ...
                        <div className="flex justify-between items-center ">
                            ...
                            <div className="flex items-center gap-2">
                                <button
                                    onClick={() => onTaskEdit(task.id, task)}
                        ...
                        {editingTask === task.id && (
                            <div className="mt-3">
                                ...
                                {/* Save Button */}
                                <button
                                    onClick={() => saveTask(task.id, editContent, editUrgency, editDeadline)}
