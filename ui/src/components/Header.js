const Header = ({ errors,
    ...
    return (
        <div className="flex flex-row mx-1 my-5 bg-none p-4 w-full">
            ...
            <div className='text-white flex flex-col mx-14 mt-5 text-2xl justify-start items-center '>
                <div className="flex flex-row items-center justify-start">
                    <span className='mr-5 ml-1 text-5xl'>Worky</span>
                    <span>
                        <svg className='h-12' xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" >
